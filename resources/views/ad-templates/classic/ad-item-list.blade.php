<a href="{{ route('ad.overview', ['slug' => $ad->slug, 'ref' => $ref]) }}" aria-label="{{$ad->title}}" wire:click="saveClicks" class=" rounded-xl hover:shadow-md dark:bg-gray-900 border dark:border-white/10 classic:border-black {{$homeSettings->enable_hover_animation?'classic-hover-shadow':''}} relative bg-white shadow-sm">
