...
<div class="messenger-infoView-btns flex items-center justify-center space-x-3 rtl:space-x-reverse">
    ...
    {{-- View profile --}}
    <a href="" id="selected-contact-view-profile-link" class="inline-flex w-full justify-center items-center px-4 py-2 border border-gray-300 dark:border-zinc-700 shadow-sm dark:shadow-none text-xs font-medium rounded-md text-gray-700 dark:text-zinc-200 bg-white dark:bg-zinc-600 hover:bg-gray-50 dark:hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-600 classic:border-black">
    ...
    {{-- Delete conversation --}}
    <button type="button" class="delete-conversation inline-flex w-full justify-center items-center px-4 py-2 border border-transparent text-xs font-medium rounded-md text-red-700 bg-red-50 hover:bg-red-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 classic:border-danger-800">
