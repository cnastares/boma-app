<x-filament-panels::page>
    ...
    <div class=" grid grid-cols-1 gap-y-10 md:flex gap-x-10">
        <div class="md:w-[50%]">
        ...
        <div class="md:w-[50%] w-full space-y-8">
            <div class=" w-full">
                @if (getSubscriptionSetting('status') &&
                        getActiveSubscriptionPlan() &&
                        in_array(getActiveSubscriptionPlan()->demographic_analysis_level, ['basic', 'advanced']))

                    <div class=" bg-white p-3 rounded-lg border classic:border-black">
                        ...
                        @if (count($ageTrafficData ?? []))
                            <table class="ageTable">
                                <thead>
                                    <tr>
                                        <th
                                            class="text-left py-2.5 rounded-ss-[14px] border-r border-[#D1D5D8] whitespace-nowrap">
                                ...
                                <tbody>
                                    @foreach ($ageTrafficData ?? [] as $data)
                                        <tr>
                                            <td class="border-r border-[#D1D5D8] p-1 whitespace-nowrap">
                                                {{ $data->age_group }}</td>
                                            <td class="border-r border-[#D1D5D8] p-1 whitespace-nowrap">
                                                {{ $data->total_views }}</td>
                                        </tr>
